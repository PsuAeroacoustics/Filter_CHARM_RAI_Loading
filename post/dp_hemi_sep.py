...
case_name = ["quickROD.1PSU-WOPWOP_HEMI_UP_BP","quickROD.1PSU-WOPWOP_HEMI_UP_PHI1_NR1_STAG"]
select_points = []
cases_fname = [ 'cases_hemi.nam', 'cases_hemi.nam']
upper = True
lambert = True
...
dist2 = ax.contour(acs_data[case_name[0]]['theta'],acs_data[case_name[0]]['rho'],doaspl,levels = levels[::2],colors = 'k',linestyles = '-.',linewidths = .7,alpha = .75)
plt.clabel(dist2)
